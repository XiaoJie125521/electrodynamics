...
\begin{document}
	...
	\begin{tikzpicture}[tdplot_main_coords, >=stealth, line cap=round, line join=round]
		...
		% ============ 3. 绘制位置矢量及其投影 ============
		\draw[line width=1.2pt, -stealth, red] (0,0,0) -- (R) node[midway, below=10pt, right=-6pt] {$\bm{r}(\rho,\varphi,z)$};
		...
		\begin{scope}[tdplot_rotated_coords]
			\draw[line width=1.5pt, -stealth, blue] (0,0,0) -- (\ar,0,0) node[right] {$\hat{\bm{e}}_\rho$};
			\draw[line width=1.5pt, -stealth, blue] (0,0,0) -- (0,\ar,0) node[above=2pt ,right=0.2pt] {$\hat{\bm{e}}_\varphi$};
			\draw[line width=1.5pt, -stealth, blue] (0,0,0) -- (0,0,\ar) node[above] {$\hat{\bm{e}}_z$};
		\end{scope}
